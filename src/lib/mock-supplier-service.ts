...
let suppliers: Supplier[] = [
  ...
  },
  {
    ...
    companyName: 'Sakura Trading',
    vatId: 'JP123456789',
    country: 'Japan',
    contactEmail: 'info@sakuratrading.jp',
    status: 'APPROVED',
    createdBy: USERS.max.name,
    createdById: USERS.max.id,
    approvedBy: USERS.anna.name,
  ...
  },
  {
    ...
    companyName: 'Alpine Equipment GmbH',
    vatId: 'AT123456789',
    country: 'Austria',
    contactEmail: 'sales@alpineequip.at',
    status: 'DRAFT',
    createdBy: USERS.anna.name,
    createdById: USERS.anna.id,
  ...
  },
  {
    ...
    companyName: 'Cape Town Imports',
    vatId: 'ZA123456789',
    country: 'South Africa',
    contactEmail: 'hello@capetownimports.za',
    status: 'REJECTED',
    createdBy: USERS.max.name,
    createdById: USERS.max.id,
    rejectedBy: USERS.anna.name,
    rejectedById: USERS.anna.id,
    rejectionReason: 'Missing import license documentation.',
